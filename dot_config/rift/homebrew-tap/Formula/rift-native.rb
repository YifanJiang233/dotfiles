...
+                    .add_window_after_selection_with_anchor_frame(layout, wid, anchor_frame);
             ...
             warn!(
@@ -1127,6 +1181,333 @@ impl LayoutEngine {
...
+
     fn remove_window_from_all_tiling_trees(&mut self, wid: WindowId) {
         ...
         for ws_id in ws_ids {
@@ -1247,7 +1628,26 @@ impl LayoutEngine {
...
+            }
             ...
             {
@@ -1347,6 +1747,7 @@ impl LayoutEngine {
             broadcast_tx,
...
@@ -1615,6 +2016,7 @@ impl LayoutEngine {
                 };
             }
...
@@ -1715,6 +2117,22 @@ impl LayoutEngine {
...
@@ -2040,6 +2458,9 @@ impl LayoutEngine {
...
@@ -2616,6 +3037,21 @@ impl LayoutEngine {
                     return EventResponse::default();
                 };
...
@@ -3082,6 +3518,7 @@ impl LayoutEngine {
